...
<%@ page import="com.buglogginginmaven.profile.ClientDetails" %>
<%@ page import="com.buglogginginmaven.database.DatabaseConnection" %>
...
<%ResultSet resultset =null; ResultSet resultset2 =null;%>
 <%
                                                                  ...
                                                                  Class.forName(databaseconnection_driver).newInstance();
                                                                //Class.forName("com.mysql.jdbc.Driver"); 
                                                                Connection connection = DriverManager.getConnection(databaseconnection_url_db ,databaseconnection_username, databaseconnection_password ); 
...
<html>
    ...
    <body bgcolor="steelblue">
        ...
        <div align="center" style='margin-top: 1%; height:550px; background-color: #f8f9fa;'">
            <h1>LoggedUserId_fetching_from_session = <%=LoggedUserId_fetching_from_session  %></h1>
<form action="LogIssue" method="post" >
			<table style="with: 50%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                     ...
                                                                                                                     <select  name="issue_project">
                                                                                                                        ...
                                                                                                                                                    <%  while(resultset2.next()){ 
                                                                                                                                        ...
                                                                                                                                        <% } %>
                                                                                                                      </select> </select>
                                                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-ruled-fill" viewBox="0 0 16 16"> <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM3 9h10v1H6v2h7v1H6v2H5v-2H3v-1h2v-2H3V9z"/> </svg>
                                                                                                        <a class="" href="../projects/addProject.jsp">Add Project</a>
                                                                                                           </th>
                                                                                                           </tr>
                                                                                                           <tr>
					<td>Issue Title</td>
					<td><input type="text" name="issue_title" style="width:550px;" /></td>
                                                                                                        ...
                                                                                                        <a class="" href="../members.jsp">  Add User</a>
                                                                                                           </th>
                                                                                                           <th> </th>
                                                                                                           </tr>
                                                                                                                                                        <%
