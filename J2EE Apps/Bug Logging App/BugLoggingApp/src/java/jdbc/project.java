         ...
         // *****TRY STATEMENT          *************** STARTS********|||||||||||||||||||||||||
                                                    ...
                                                    {  
                                                                        ...
                                                                        ResultSet rs = stmt.executeQuery("select * from project");    System.out.println("select * from project"); 
                                                                          out.println("<form action=projects method=post> <input type=\"submit\" value=\"delete\" name=\"delete\"/>");  
                                                                        out.println("<table border=1 width=50% height=50% color=lightgreen>");  
                                                                        out.println("<tr><th>Select</th><th>id</th><th>project_name</th><th>project_description</th><th>project_uid</th><tr>");  
                                                                        while (rs.next()) 
                                                                        {  
