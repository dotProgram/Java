...
res.sendRedirect("display");
 ...
 //DatabaseConnection databaseconnection_obj = new DatabaseConnection();
                    ...
                    System.out.println("Password blow");    
                       System.out.println(databaseconnection_password);     
                       System.out.println("Password above");    
         ...
         // *****TRY STATEMENT          *************** STARTS********|||||||||||||||||||||||||
                                                    ...
                                                    out.println(databaseconnection_url_db+", "+ databaseconnection_username+","+databaseconnection_password);
     }  //doPost ENDS /\/
