...
//res.sendRedirect("projects/project.jsp");
      ...
      {  
           ...
           out.println("<h1><br>-----------------------------------------------------------------</h1><br>");  
             ...
             System.out.println("<h1>Handeling the  detail request</h1><br>");  
        
           detailRequest(out, id);
         //  System.out.println("<h1><br>-----------------------------------------------------------------</h1><br>");  
           }
   ...
   out.println("</body></html>");                                                  
     ...
     return "f";}
          ...
          private String  detailRequest(PrintWriter out, int id){
                                                                    ...
                                                                    try 
                                                    {  
                                                                        out.println("Inside Method detailRequest");  
                                                                        Class.forName(databaseconnection_driver);  
                                                                        Connection con = DriverManager.getConnection(databaseconnection_url_db ,databaseconnection_username, databaseconnection_password );                                                             System.out.println("Reached DriverManager  jdbc:mysql://localhost:3306/servlet");                                                                                                                                  System.out.println("Reached DriverManager  jdbc:mysql://localhost:3306/servlet"); 
                                                                        // Here dsnname- mydsn,user id- system(for oracle 10g),password is pintu.  
                                                                        Statement stmt = con.createStatement();  
          ...
          private String  editDetailRequest(PrintWriter out, int id){
                                                    ...
                                                    {  
                                                                        ...
                                                                        {  
                                                                            ...
                                                                            System.out.println("Edit While loop"); 
                                                                            String project_description = rs.getString("project_description");  
                                                                            String project_uid = rs.getString("project_uid");  
        ...
        return "processDeleteRequest Sussess";
          ...
          private String  processUpdateRequest(PrintWriter out, int id, String project_name, String project_description ){
                                                    try {
                                                                                    ...
                                                                                    Class.forName(databaseconnection_driver);                                                                                                                                                                
                                                                                    System.out.println("Reached com.mysql.jdbc.Driver = "+databaseconnection_driver); 
                                                                                    Connection con = DriverManager.getConnection(databaseconnection_url_db ,databaseconnection_username, databaseconnection_password );                                                             
                                                                                  ...
                                                                                  //  PreparedStatement ps = con.prepareStatement("update project set (project_name, project_description) values(?,?) where id = " + id +";");  System.out.println("Reached UPDATE PreparedStatement");
                                                                                    PreparedStatement ps = con.prepareStatement("update project set project_name = '"+project_name +"', project_description  = '"+ project_description +"'  where id = " + id +";"); 
                                                                                    System.out.println("Reached UPDATE PreparedStatement");
                                                                                    System.out.println("Update statement in SQL \n"+"update project set project_name = '"+project_name +"', project_description  = '"+ project_description +"'  where id = " + id +";"); 
                                                                                   // ps.setString(1,);
