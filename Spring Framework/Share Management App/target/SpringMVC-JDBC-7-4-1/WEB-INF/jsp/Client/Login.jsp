...
Model session_first_name = ${model_session_first_name} <br>
session_first_name = ${session_first_name} <br>

<div class="div-center" style="background-color:lightgreen; margin:auto;">
<form:form method="POST" action="Client/Login2">
      	...
      	<table class="table div-center" style="background-color:steelblue;">  
      	<tr>
      	<th></th><th>Login</th> 
        </tr> 
